...
<body class="antialiased text-gray-800 bg-white">
  ...
  <div class="max-w-7xl mx-auto px-6 flex items-center justify-between h-16">
    {{-- Logo --}}
    <a href="/" class="text-xl font-bold text-blue-600"><img src="{{ asset('images/tools/Logo original noir.png') }}"  class="w-32 h-auto"></a>
  ...
  <a href="/" class="relative group text-gray-700">
    Accueil
    <span
      class="absolute left-0 -bottom-1 w-full h-0.5  scale-x-0 group-hover:scale-x-100 transition-transform origin-left" style="background-color: #17e5f3;"
    ></span>
  </a>
  ...
  <nav id="mobile-menu" class="hidden md:hidden bg-white shadow-md">
    ...
    <a href="{{ route('about') }}" class="block px-6 py-3 border-b border-gray-200 hover:bg-gray-100">À propos</a>
    <a href="{{ route('realisations') }}" class="block px-6 py-3 border-b border-gray-200 hover:bg-gray-100">Réalisations</a>
    ...
    <div class="flex flex-col md:flex-row md:justify-between md:items-start space-y-10 md:space-y-0 gap-x-40 ">
      ...
      <div class="md:w-4/4 grid grid-cols-2 gap-x-30">
        ...
        <div>
          ...
          <ul class="space-y-3">
            <li><a href="https://www.facebook.com/share/17MR87bBio/?mibextid=wwXIfr" class="hover:text-white transition">Facebook</a></li>
            <li><a href="https://www.instagram.com/parfaitdavila?igsh=MXExeWduaDJ4cXNueA%3D%3D&utm_source=qr" class="hover:text-white transition">Instagram</a></li>
            <li><a href="https://www.linkedin.com/in/parfait-tozo-237388249" class="hover:text-white transition">LinkedIn</a></li>
            <li><a href="https://wa.me/22997294155" class="hover:text-white transition">WhatsApp</a></li>
          </ul>
        </div>
        </div>
